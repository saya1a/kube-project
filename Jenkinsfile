            ...
            steps {
                script {
                    ...
                    //docker.withRegistry("https://${ecrRegistry}", 'ecr:us-east-1') {
                        ...
                        //dockerImage.push()
                    sh "docker tag mybusybox:1.1.2 121247432410.dkr.ecr.us-east-1.amazonaws.com/mykube-repo:mybusybox:1.1.3"
                    sh "docker push 121247432410.dkr.ecr.us-east-1.amazonaws.com/mykube-repo:mybusybox:1.1.3"
                }
            }
        }
    }
